...
class Manager extends Component {
    ...
    componentDidMount() {
        this.props.get_specific_employees({type: "Manager"});
    }

    render() {
        let list = null;
        if (this.props.reducer.Managers !== null) {
            list = this.props.reducer.Managers.map(obj => {
                    return (
        ...
        return (
            <React.Fragment>
                ...
                <Button variant="primary" onClick={()=>{this.props.get_specific_employees({type: "Manager"})}}>
                    Refresh
                </Button>
            </React.Fragment>
        );
